...
import { FaFacebook, FaTwitter, FaLinkedin, FaPhone, FaMapMarkerAlt, FaCogs } from "react-icons/fa";
...
const Contact = () => {
    ...
    const [menuOpen, setMenuOpen] = useState(false); // State to manage the toggle menu
    ...
    return (
        <section className="relative w-screen min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 p-12">
            ...
            <div className={`absolute top-1/2 right-8 transform -translate-y-1/2 flex flex-col space-y-4 ${menuOpen ? 'block' : 'hidden'} z-30`}>
            ...
            <div className="relative bg-white shadow-2xl rounded-xl p-8 w-full md:w-1/3 z-10 min-w-[300px]">
            ...
            {/* Double Gears Icon for Menu */}
            <div
                className="absolute bottom-8 right-8 flex items-center justify-center w-16 h-16 bg-white rounded-full shadow-lg cursor-pointer z-20"
